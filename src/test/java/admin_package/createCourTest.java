...
public class createCourTest {
	...
	public void courseCreation() throws IOException {
		...
		driver.findElement(By.id("id_fullname")).sendKeys("Automation selenium Testng");
		driver.findElement(By.id("id_shortname")).sendKeys("java sele");
		...
		driver.findElement(By.id("id_idnumber")).sendKeys("19999");
